  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <q-space/>
        <div class="q-gutter-sm right_btns row items-center no-wrap">
          ...
          <q-btn round flat>
            ...
            <q-menu anchor="bottom left" class="setting_bar" self="top left">
            <q-item clickable to="/Profile">
              <q-item-section class="menu_settings q-pr-sm" avatar>
                <q-icon name="settings"/>
              </q-item-section>
              <q-item-section>
                <q-item-label>Կարգավորումներ</q-item-label>
              </q-item-section>
            </q-item>
            <q-item clickable @click="logoutUser">
              ...
              <q-item-section>
                <q-item-label>Դուրս գալ</q-item-label>
              </q-item-section>
            </q-item>
          </q-menu>
          </q-btn>
    ...
    >
      <q-list>
        <q-item to="/" exact active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="dashboard"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>Վահանակ</q-item-label>
          </q-item-section>
        </q-item>
        <q-item to="/products" exact active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="list"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>Ապրանքներ</q-item-label>
          </q-item-section>
        </q-item>
        <q-item to="/sales" exact active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="shopping_cart"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>Վաճառք</q-item-label>
          </q-item-section>
        </q-item>
        <q-item to="/income" exact active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="paid"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>Եկամուտ</q-item-label>
          </q-item-section>
        </q-item>
    ...
    export default {
        ...
        mounted() {
          axios.defaults.headers.common['Authorization'] = `Bearer ${this.token}`
            axios.get('http://tt-api.loc/api/user',
            ).then((res)=>{
            if(res.data){
